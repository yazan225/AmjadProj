...
function startNewInvoice() {
    ...
    // تم إزالة الخصم الكلي من الجلسة
}
...
if (isset($_POST['save_invoice']) && count($_SESSION['cart']) > 0) {
    ...
    // تم إزالة الخصم الكلي على الفاتورة
    ...
    $total = $sub_total; // تم إزالة الخصم الكلي
    ...
    try {
        ...
        $stmt = $conn->prepare($sql);
        $due_date = $tran_date;
        $discount_amount = 0; // تم إزالة الخصم الكلي
    ...
    if (!isset($_POST['paid_amount']) || !isset($_POST['invoice_total']) || !isset($_POST['invoice_no'])) {
        ...
        if ($paid_amount <= 0) {
            ...
            if ($change < 0) {
                ...
                // إصلاح الاستعلام - إضافة المعلمات المفقودة
