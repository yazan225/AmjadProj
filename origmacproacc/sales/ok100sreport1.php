...
<head>
    ...
    <style>
        ...
        .main-table th:nth-child(1) { width: 10%; } /* كود الصنف */
        .main-table th:nth-child(2) { width: 20%; } /* اسم الصنف */
        .main-table th:nth-child(3) { width: 15%; } /* الفئة */
        .main-table th:nth-child(4) { width: 8%; }  /* الكمية */
        .main-table th:nth-child(5) { width: 10%; } /* متوسط السعر */
        .main-table th:nth-child(6) { width: 10%; } /* متوسط التكلفة */
        .main-table th:nth-child(7) { width: 12%; } /* قيمة المبيعات */
        .main-table th:nth-child(8) { width: 12%; } /* قيمة التكلفة */
        .main-table th:nth-child(9) { width: 10%; } /* الربح */
        .main-table th:nth-child(10) { width: 8%; } /* نسبة الربح */
    </style>
</head>
<body>
    <div class="container">
        ...
        if (isset($_POST['Refresh'])) {
            ...
            $sql = "SELECT 
                        ...
                        SUM(sm.qty * sm.price) as sales_amount,
                        SUM(sm.qty * sm.standard_cost) as cost_amount,
                        SUM((sm.qty * sm.price) - (sm.qty * sm.standard_cost)) as profit,
            ...
            if (!$result) {
                ...
                if ($row_count > 0) {
                    ...
                    while ($myrow = $result->fetch_assoc()) {
                        ...
                        $profit = $myrow['profit'];
                        $profit_percent = ($sales_amount != 0) ? ($profit / $sales_amount) * 100 : 0;
                        ...
                        if ($show_details) {
                            // استعلام للحصول على تفاصيل الحركات مع معلومات العميل والمستودع
                            $detail_sql = "SELECT 
                                        sm.tran_date, 
                                        sm.reference, 
                                        sm.type,
                                        ...
                                        sm.price, 
                                        sm.standard_cost,
                                        (sm.qty * sm.price) as line_total,
                                        (sm.qty * sm.standard_cost) as line_cost,
                                        ((sm.qty * sm.price) - (sm.qty * sm.standard_cost)) as line_profit,
                                        dt.debtor_no,
                            ...
                            if ($detail_result && $detail_result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='10' style='padding:0;'>";
                                ...
                                echo "<tr>";
                                echo "<th style='width:9%;'>التاريخ</th>";
                                echo "<th style='width:10%;'>المرجع</th>";
                                echo "<th style='width:7%;'>النوع</th>";
                                echo "<th style='width:7%;'>الكمية</th>";
                                echo "<th style='width:9%;'>سعر الوحدة</th>";
                                echo "<th style='width:9%;'>إجمالي السعر</th>";
                                echo "<th style='width:9%;'>تكلفة الوحدة</th>";
                                echo "<th style='width:9%;'>إجمالي التكلفة</th>";
                                echo "<th style='width:9%;'>الربح</th>";
                                echo "<th style='width:11%;'>العميل</th>";
                                echo "<th style='width:11%;'>المخزن</th>";
                                echo "</tr>";
                    ...
                    // Display summary row
                    $total_profit_percent = ($total_sales != 0) ? ($total_profit / $total_sales) * 100 : 0;
