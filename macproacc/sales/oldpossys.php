...
if (isset($_POST['save_invoice']) && count($_SESSION['cart']) > 0) {
    ...
    try {
        ...
        error_log("بدء حفظ الفاتورة - الزبون: " . $walkin_debtor_no . ", الفرع: " . $branch_code . ", العملة: " . $main_currency . ", الموقع: " . $default_location);
        ...
        $memo_ = "فاتورة مبيعات رقم " . $trans_no . " - العملة: " . $main_currency . " - الموقع: " . $default_location;
    ...
    if (!isset($_POST['paid_amount']) || !isset($_POST['invoice_total']) || !isset($_POST['invoice_no'])) {
        ...
        if ($paid_amount <= 0) {
            ...
            if ($change < 0) {
                ...
                // إدخال حركة الدفع - مبسط بدون تعقيدات
