...
class general_ledger_app extends application
{
 ...
 $this->add_lapp_function(2, _("&Profit and Loss Statement"),
    "reporting/profitrep.php", 'SA_CURRENCY', MENU_MAINTENANCE);
 $this->add_lapp_function(2, _("Trial &Balance"),
    "reporting/tbalance.php", 'SA_CURRENCY', MENU_MAINTENANCE);
 $this->add_lapp_function(2, _("&Balance Sheet"),
    "reporting/bsheet.php", 'SA_CURRENCY', MENU_MAINTENANCE);
